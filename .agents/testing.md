...
> Rules for automated testing, test data safety, strict test integrity, and 100% coverage target in Lensio.
...
2. Developer generates a new API key (`lensio_live_...`) with `ocr:write` scope and copies the key.
